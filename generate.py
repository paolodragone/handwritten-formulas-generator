...
def generate(args):
    ...
    for i in range(args.n_samples):
        ...
        for d in digits_1:
            ...
            digit_image = process_image(digit_file)
            images_1.append(digit_image)

        plus_file = np.random.choice(files[10])
        plus_image = process_image(plus_file)
        ...
        equal_image = process_image(equal_file)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--max-max_value', type=int, default=999)
